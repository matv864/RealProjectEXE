window.onload = function() {
  ...
  img_switch_off.src = '../images/switch_off.png';

  var img_switch_on = new Image();
  img_switch_on.src = '../images/switch_on.png';
  
  var img_not = new Image();
  img_not.src = '../images/not.png';

  var img_and = new Image();
  img_and.src = '../images/and.png';

  var img_or = new Image();
  img_or.src = '../images/or.png';
  
  var img_lamps = new Image();
  img_lamps.src = '../images/lamps.png';
  ...
  function main_move(){
    ...
    window.addEventListener("click", event_mouse);
